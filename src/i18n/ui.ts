...
export const ui = {
    en: {
        ...
        "home.locations.description3": "Most of our events take place at the cafés shown on the map below.",
    ...
    ja: {
        ...
        "home.locations.description3": "ほとんどのイベントは、以下の地図に示されているカフェで開催されています。",
